...
function ad_sharing_plug_pages() {
	...
	if ( is_site_admin() ) {
		add_submenu_page('wpmu-admin.php', 'Advertising', 'Advertising', 10, 'site-advertising', 'ad_sharing_site_output');
	}
	...
	switch( $_GET[ 'action' ] ) {
		...
		case "process":
			if ( isset( $_POST[ 'Reset' ] ) ) {
				...
				window.location='wpmu-admin.php?page=site-advertising&updated=true&updatedmsg=" . urlencode(__('Changes saved.')) . "';
				</script>
				";			
			} else {
				...
				update_site_option( "advertising_location_before_post_content", $_POST[ 'advertising_location_before_post_content' ] );
				update_site_option( "advertising_location_after_post_content", $_POST[ 'advertising_location_after_post_content' ] );
				update_site_option( "advertising_location_before_page_content", $_POST[ 'advertising_location_before_page_content' ] );
				update_site_option( "advertising_location_after_page_content", $_POST[ 'advertising_location_after_page_content' ] );
				echo "
				<SCRIPT LANGUAGE='JavaScript'>
				window.location='wpmu-admin.php?page=site-advertising&updated=true&updatedmsg=" . urlencode(__('Changes saved.')) . "';
				</script>
