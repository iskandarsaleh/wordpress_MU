...
function wp_ozh_wsa_print_context() {
	...
	$help = get_bloginfo('wpurl').'/wp-content/mu-plugins/'.dirname($wp_ozh_wsa['path']).'/images/help.gif';
	$help = "<img src='$help' />";
	...
	$ok = get_bloginfo('wpurl').'/wp-content/mu-plugins/'.dirname($wp_ozh_wsa['path']).'/images/ok.gif';
...
function wp_ozh_wsa_print_help() {
	...
	$wand = get_bloginfo('wpurl').'/wp-content/mu-plugins/'.dirname($wp_ozh_wsa['path']).'/images/wand.gif';
...
function wp_ozh_wsa_print_duplicate() {
	...
	$duplicate = get_bloginfo('wpurl').'/wp-content/mu-plugins/'.dirname($wp_ozh_wsa['path']).'/images/duplicate.gif';
	$rename = get_bloginfo('wpurl').'/wp-content/mu-plugins/'.dirname($wp_ozh_wsa['path']).'/images/rename.gif';
...
function wp_ozh_wsa_print_delete() {
	...
	$cancel = get_bloginfo('wpurl').'/wp-content/mu-plugins/'.dirname($wp_ozh_wsa['path']).'/images/cancel.gif';
...
function wp_ozh_wsa_print_misc() {
	...
	$dollar = get_bloginfo('wpurl').'/wp-content/mu-plugins/'.dirname($wp_ozh_wsa['path']).'/images/paypal-dollar.gif';
	$euro = get_bloginfo('wpurl').'/wp-content/mu-plugins/'.dirname($wp_ozh_wsa['path']).'/images/paypal-euro.gif';
	$pound = get_bloginfo('wpurl').'/wp-content/mu-plugins/'.dirname($wp_ozh_wsa['path']).'/images/paypal-pound.gif';
...
$images = get_bloginfo('wpurl').'/wp-content/mu-plugins/'.dirname($wp_ozh_wsa['path']).'/images';
...
function wp_ozh_wsa_processforms_add() {
	...
	if ($_POST['serialize'] == '') {
		...
		$pattern = "/\r\n/";
		$replace = "&";
		$post_data = preg_replace($pattern, $replace,$post_data);
