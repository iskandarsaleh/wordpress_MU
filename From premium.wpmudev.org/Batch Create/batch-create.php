...
$batch_create_current_version = '1.0.0';
//------------------------------------------------------------------------//
//---Hook-----------------------------------------------------------------//
//------------------------------------------------------------------------//
...
function batch_create_plug_pages() {
	...
	add_submenu_page('wpmu-admin.php', 'Batch Create', 'Batch Create', 10, 'batch-create', 'batch_create_page_main_output');
}
	...
	*/
	...
	switch( $_GET[ 'action' ] ) {
		...
		case "process":
			...
			window.location='wpmu-admin.php?page=batch-create&updated=true&updatedmsg=" . urlencode(__('Items added to queue.')) . "';
			</script>
			";
			} else{
		...
		case "loop":
			...
			if ($tmp_queue_count_count == 0){
				echo "
				<SCRIPT LANGUAGE='JavaScript'>
				window.location='wpmu-admin.php?page=batch-create&updated=true&updatedmsg=" . urlencode(__('Finished!')) . "';
				</script>
				";	
			} else {
				?>
				...
				echo "
				<SCRIPT LANGUAGE='JavaScript'>
				window.location='wpmu-admin.php?page=batch-create&action=loop';
				</script>
				";
				*/
			}
...
null,null,username3,userpass3,useremail3@domain.com<br />
		...
		case "clear":
			...
			echo "
			<SCRIPT LANGUAGE='JavaScript'>
			window.location='wpmu-admin.php?page=batch-create&updated=true&updatedmsg=" . urlencode(__('Queue cleared.')) . "';
			</script>
			";
		break;
		//---------------------------------------------------//
