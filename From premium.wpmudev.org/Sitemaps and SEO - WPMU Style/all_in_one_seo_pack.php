...
//don't run on signup page
if ( !strpos($_SERVER['REQUEST_URI'], 'wp-signup.php') && !strpos($_SERVER['REQUEST_URI'], 'wp-login.php') && !strpos($_SERVER['REQUEST_URI'], 'wp-activate.php') && !strpos($_SERVER['REQUEST_URI'], 'wp-trackback.php') ) {
