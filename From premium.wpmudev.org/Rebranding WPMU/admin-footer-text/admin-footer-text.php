...
function admin_footer_text_site_admin_options_process() {
	$admin_footer_text = $_POST['admin_footer_text'];
	if ( empty( $admin_footer_text ) ) {
		$admin_footer_text = 'empty';
	}
	update_site_option( 'admin_footer_text' , $admin_footer_text );
}
...
function admin_footer_text_output($footer_text) {
	...
	$admin_footer_text = stripslashes( get_site_option('admin_footer_text') );
	if ( $admin_footer_text == 'empty' ) {
		$admin_footer_text = '';
	}
	if ( !empty( $admin_footer_text_default ) && empty( $admin_footer_text ) ) {
