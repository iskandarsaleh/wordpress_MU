...
<div class="post-author"><?php the_time('jS F Y') ?> <?php _e( 'by', 'buddypress' ) ?> <?php the_author_posts_link(); ?> <?php _e( 'under', 'buddypress' ) ?> <?php the_category(', ') ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php edit_post_link(__('edit')); ?></div>
