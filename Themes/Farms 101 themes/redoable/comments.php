...
<?php return; } } ?>
	...
	<hr />
		...
		<ol id="commentlist">
			...
			<?php foreach ($redo_comment_list as $comment_index => $comment) { ?>

			<li id="comment-<?php comment_ID(); ?>" class="<?php redo_comment_class($comment_index); ?>" >
				...
				<span class="commentauthor"><?php if (function_exists('avatar_display_comments')){ avatar_display_comments(get_comment_author_email(),'48',''); } ?>&nbsp;&nbsp;
