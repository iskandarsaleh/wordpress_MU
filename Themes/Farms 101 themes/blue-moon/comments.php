...
<?php
$isByAuthor = false;
if($comment->comment_author_email == 'USERNAME@YOURDOMAIN.COM') {
$isByAuthor = true;
}
?>
...
<h2 id="nocomment"><?php ('No comments yet');?></h2>
<?php else : // comments are closed ?>
<!-- If comments are closed. -->
<li style="display:none"></li>
</ol>
<p><?php ('Comments are closed.');?></p>
<?php endif; ?>
  <?php endif; ?>
...
<div id="errors"></div>
  ...
  <p> <?php _e('You must be');?> <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php the_permalink(); ?>"><?php ('logged in');?></a> <?php ('to post a comment.');?> </p>
  <?php else : ?>
  <div id="commentsform">
