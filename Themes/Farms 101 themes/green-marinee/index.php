...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	...
	<div class="main">
		<?php if (function_exists('wp_ozh_wsa')) { wp_ozh_wsa("336280nocolor"); } ?><?php the_content(__('(more...)','greenmarinee')); ?><?php if (function_exists('wp_ozh_wsa')) { wp_ozh_wsa("336280nocolor"); } ?>
	</div>
	</div>
	<div class="comments">
		<?php wp_link_pages(); ?>
