...
<?php endif; ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			...
			<p class="metadate"><?php _e('on');?> <?php comment_date('F jS, Y') ?> <?php _e('at');?> <?php comment_time() ?></p>
...
<p><input name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('Submit Comment');?>" title="Please review your comment before submitting" />
