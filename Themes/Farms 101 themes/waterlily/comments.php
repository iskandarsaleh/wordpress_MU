...
<div class="main_title" id="comments"><?php comments_number(__('No Responses'), __('One Response'), __('% Responses' ));?> <?php _e('to');?>  &#8220;<?php the_title(); ?>&#8221;</div>
...
<div class="comment-author"><?php if (function_exists('avatar_display_comments')){ avatar_display_comments(get_comment_author_email(),'48',''); } ?>&nbsp;&nbsp;<?php comment_author_link() ?> <?php _e('says');?>: </div>
...
<span class="commentmetadata"><?php comment_date() ?> @ <?php comment_time(); ?> <?php edit_comment_link('e','',''); ?></span>
...
<label for="email"><small  if ($req) _e('(required)'); ?></small></label></p>
