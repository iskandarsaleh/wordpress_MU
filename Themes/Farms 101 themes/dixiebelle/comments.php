...
<!--
		<a href="http://www.gravatar.com"><img src="<?php // gravatar("R", 80, "/images/sample.gif", "" ); ?>" alt="Get your own gravatar for comments by visiting gravatar.com" class="gravatar" /></a>	
-->
		<p class="commentby"><?php if (function_exists('avatar_display_comments')){ avatar_display_comments(get_comment_author_email(),'48',''); } ?>&nbsp;&nbsp; <?php comment_author_link() ?></p>
