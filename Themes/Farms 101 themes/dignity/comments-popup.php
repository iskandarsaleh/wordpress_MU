...
<p class="credit">
  ...
  <cite><?php _e('Powered by');?> <a href="http://wordpress.org/" title="<?php _e('Powered by WordPress, state-of-the-art semantic personal publishing platform');?>"><strong>Wordpress</strong></a></cite></p>
