<?php get_header() ?>
	...
	<div id="sidebar">
		...
		<h2><?php _e('Currently Browsing') ?></h2><ul><li><p><?php _e('You have searched the archives');?>
			...
			<?php _e('for');?> <strong>'<?php echo wp_specialchars($s, 1); ?>'</strong>. <?php _e('If you are unable to find anything in these search results, you can try one of these links.');?></p></li></ul>
