...
<strong><?php comment_author_link() ?> </strong>
				<span class="comment_time">// <?php comment_date('M j, Y') ?> <?php _e('at');?> <?php comment_time() ?></span>
			</p>
			<div class="entry">
				<?php comment_text() ?> 
	...
	<?php if ('open' == $post-> comment_status) : ?>
		...
		<?php else : ?>
			...
			<h3 id="respond" class="comments_headers"><?php _e('Leave a Comment');?></h3>
			...
			<?php } ?>
				...
				<p><textarea class="text_input text_area" name="comment" id="comment" rows="12" tabindex="4"></textarea></p>
