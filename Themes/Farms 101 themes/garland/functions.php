...
<script type="text/javascript">
	imgObj = new Image();
	imgObj.src = "/wp-content/themes/pub/garland/image.php?src=preview.png&top=$_top&bottom=$_bottom&base=$_base";
...
<style type="text/css">
	#preview {
		width: 596px;
		height: 371px;
		background: url("/wp-content/themes/pub/garland/image.php?src=preview.png&top=$_top&bottom=$_bottom&base=$_base");
		position: relative;
		margin: 0 auto;
		color: $text;
	}
