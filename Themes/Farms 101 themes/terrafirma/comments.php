...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			<div class="cmtinfo"><small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title="">#</a> </small><?php if (function_exists('avatar_display_comments')){ avatar_display_comments(get_comment_author_email(),'48',''); } ?>&nbsp;&nbsp;<cite><?php comment_author_link() ?></cite><em><?php _e('on');?> <?php comment_date('d M Y') ?> <?php _e('at');?> <?php comment_time() ?> <?php edit_comment_link('edit this','',''); ?></em></div>
...
<?php if ($post-> comment_status == "open") {?>
  <span class="commentsrss"><?php comments_rss_link('Comments RSS'); ?></span>
<?php }; ?>
</p>
</div>
