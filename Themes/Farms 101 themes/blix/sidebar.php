...
<?php if (is_home()) { ?>
	...
	<h2><em><?php ('Feeds');?></em></h2>



	<ul class="feeds">

	<li><a href="<?php bloginfo_rss('rss2_url'); ?> "><?php ('Entries (RSS)');?></a></li>

	<li><a href="<?php bloginfo_rss('comments_rss2_url'); ?> "><?php ('Comments (RSS)');?></a></li>
...
<?php if (is_single()) { ?>
	...
	<h2><em><?php ('Most Recent Posts');?></em></h2>
...
<?php if (is_page("archives") || is_archive() || is_search()) { ?>
	...
	<?php if (!is_page("archives")) { ?>
		...
		<h2><em><?php ('Posts by Month');?></em></h2>
	...
	<h2><em><?php ('Posts by Category');?></em></h2>
