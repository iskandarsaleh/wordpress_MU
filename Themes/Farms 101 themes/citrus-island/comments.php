...
<?php if ($comments) : ?>
	...
	<ol class="commentlist" style="margin:0px">

	<?php foreach ($comments as $comment) : ?>

		<li style="list-style:none;" class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
...
<p><label for="author"><small><?php _e('Name');?> <?php if ($req) echo "__('(required)')"; ?></small></label>
<input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" />

<label for="email"><small><?php _e('Mail (will not be published)');?> <?php if ($req) echo "__('(required)')"; ?></small></label>
