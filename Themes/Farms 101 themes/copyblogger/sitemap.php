...
<?php get_header(); ?>
	...
	<div id="content_box">
		...
		<div id="content" class="page">
			...
			<h1><?php the_title(); ?></h1>
			<div class="entry">
				<p><strong><?php _e('All internal pages:');?></strong></p>
				<ul>
				...
				<p><strong><?php _e('Monthly archive pages:');?></strong></p>
				<ul>
					<?php wp_get_archives('type=monthly'); ?>
				</ul>
				<p><strong><?php _e('Topical archive pages:');?></strong></p>
				<ul>
					<?php wp_list_categories('title_li=0'); ?>
				</ul>
				<p><strong><?php _e('Available RSS Feeds'):?>:</strong></p>
				<ul>
