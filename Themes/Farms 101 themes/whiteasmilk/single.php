...
<?php get_header(); ?>
  ...
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<div class="post">
			...
			<div class="entry">
		<?php if (function_exists('wp_ozh_wsa')) { wp_ozh_wsa("336280nocolor"); } ?>		<?php the_content('<p class="serif">'.__('Read the rest of this entry &raquo;','whiteasmilk').'</p>'); ?><?php if (function_exists('wp_ozh_wsa')) { wp_ozh_wsa("336280nocolor"); } ?>
	
				<?php link_pages(__('<p><strong>'.__('Pages').':</strong> ','whiteasmilk'), '</p>', 'number'); ?>
