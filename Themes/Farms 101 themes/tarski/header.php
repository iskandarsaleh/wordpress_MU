...
<div id="header">
	...
	<div id="navigation">
		<ul id="nav-1">
			<li><a title="Return to front page" href="<?php echo get_settings('home'); ?>"><?php _e('Home');?></a></li>
			<?php wp_list_pages('sort_column=post_title&depth=1&title_li='); ?>
		</ul>

		<ul id="nav-2">
			<li><a class="feed" title="<?php _e('Subscribe to the');?> <?php bloginfo('name'); ?> feed" href="<?php echo get_bloginfo_rss('rss2_url'); ?>">Subscribe to feed</a></li>
		</ul>
	</div>
