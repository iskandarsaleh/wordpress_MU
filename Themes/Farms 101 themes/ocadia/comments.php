...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="comment<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			...
			<p class="commentauthor"><?php if (function_exists('avatar_display_comments')){ avatar_display_comments(get_comment_author_email(),'48',''); } ?>&nbsp;&nbsp;
<?php comment_author_link() ?> <?php _e('said'); ?>,</p>
