...
<?php while (have_posts()) : the_post(); ?>
					...
					<li id="post-<?php the_ID(); ?>" style="margin-bottom:1em;">
						...
						<br/><?php if (function_exists('wp_ozh_wsa')) { wp_ozh_wsa("336280nocolor"); } ?>
						<em><?php the_content_rss('', TRUE, '', 30); ?></em><?php if (function_exists('wp_ozh_wsa')) { wp_ozh_wsa("336280nocolor"); } ?>
						<br />
