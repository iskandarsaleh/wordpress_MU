...
<?php if ( is_single() ) { ?> &raquo; <?php _e('Blog Archive');?> <?php } ?>
<?php wp_title(); ?></title>
...
<div id="buttons"><ul id="mainlevel-nav"><li><a <?php if (is_home()) echo " class=\"selected\""; ?> href="<?php bloginfo('url'); ?>"><?php _e('Home');?></a></li>
		<?php
		$pages = BX_get_pages();
		if ($pages) {
