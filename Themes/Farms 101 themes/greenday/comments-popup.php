...
<head>
     <title><?php echo get_settings('blogname'); ?> - <?php _e('Comments');?> <?php _e('on');?> <?php the_title(); ?></title>
...
<?php //} ?> 
<p class="credit"><?php timer_stop(1); ?> <cite><?php _e('Powered by');?> <a href="http://wordpress.org/" title="<?php _e('Powered by WordPress, state-of-the-art semantic personal publishing platform');?>"><strong>Wordpress</strong></a></cite></p>
