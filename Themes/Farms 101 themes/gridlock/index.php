...
<div id="main_content">
	...
	<!-- post content -->
	<?php if (function_exists('wp_ozh_wsa')) { wp_ozh_wsa("336280nocolor"); } ?><?php the_content('<em><strong>continue reading... &raquo;</strong></em>'); ?><?php if (function_exists('wp_ozh_wsa')) { wp_ozh_wsa("336280nocolor"); } ?>

	<h4 class="comment">posted <?php the_time('j F Y'); ?> @ <?php the_time('G:i'); ?> <?php _e('by');?> <?php the_author() ?>  
	 &raquo; <?php the_tags( '&nbsp;' . __( 'and tagged' ) . ' ', ', ', ''); ?> <?php comments_popup_link(__('0 Comments'), __('One Comment'), __('% Comments'), '', __('Comments Locked')); ?> </h4>
	...
	<div class="substory" id="left">
				...
				<h4 class="substory_comment"><?php the_time('j F Y'); ?>
				 &raquo; <a href="<?php the_permalink(); ?>">read</a> &raquo; <?php the_tags( '&nbsp;' . __( 'tagged' ) . ' ', ', ', ''); ?>
				 <?php comments_popup_link(__('0 Comments'), __('One Comment'), __('% Comments'), '', __('Comments Locked')); ?></h4>
	</div>
	<?php endwhile;?>
