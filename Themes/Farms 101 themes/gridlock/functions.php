...
<div class="wrap">
	<div id="gridlock-div">
		...
		<form name="gridlock" method="post" action="<?php attribute_escape($_SERVER['REQUEST_URI']); ?>">
		...
		<div id="gridlockCaption">
			<p><strong>Gridlock 1.4b1</strong> (Build 5) &copy; 2005-2006 Eston Bond. Some rights reserved.</p>
...
define('HEADER_IMAGE_WIDTH', 767);
define('HEADER_IMAGE_HEIGHT', 89);
