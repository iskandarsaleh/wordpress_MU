...
<a href="<?php echo get_settings('home'); ?>"><img src="<?php header_image() ?>" width="767" height="89" alt="Homepage logo" /></a> 
<?php } ?>
</div>
...
<div id="upper"> 
	...
	<div class="nav"><a href="<?php bloginfo('url'); ?>/<?php echo(get_option('gridlock_about_slug')); ?>" title="about"><?php _e('about');?></a></div>
	<!-- /change these links to suit your site -->
	<?php } ?>
