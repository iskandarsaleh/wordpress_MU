...
<?php if ($comments) : ?>
	...
	<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			...
			<div class="commenttitle"><cite><?php comment_author_link() ?></cite> <?php _e('Says');?>:
			<?php if ($comment->comment_approved == '0') : ?>
			<em><?php _e('Your comment is awaiting moderation.');?></em>
			<?php endif; ?> 
			<br />

			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?> <?php _e('at');?> <?php comment_time() ?></a> <?php if ( $user_ID ) { edit_comment_link('e','',''); } ?></small>
</div> <div class="commentbody">
			<br /><?php if (function_exists('avatar_display_comments')){ avatar_display_comments(get_comment_author_email(),'48',''); } ?>&nbsp;&nbsp;<?php comment_text() ?> </div>
