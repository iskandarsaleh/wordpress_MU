...
<?php if (function_exists('wp_ozh_wsa')) { wp_ozh_wsa("72890nocolor"); } ?>
	...
	<div class="meta"><?php _e('Filed under:','classic'); ?>  <?php the_category(',') ?> &#8212; <?php the_author() ?> @ <?php the_time() ?> <?php edit_post_link(__('Edit This','classic')); ?><br /><?php the_tags(__('Tags: '), ', ', '<br />'); ?></div>
