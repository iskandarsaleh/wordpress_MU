<!-- menu -->
	...
	<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('leftsidebar') ) : ?>
			...
			<p><span class="feedarea"></span><a href="<?php bloginfo('rss2_url'); ?>" title="<?php _e('Syndicate this site using RSS'); ?>"> <?php ('Grab my feed');?></a>
		    ...
		    <div id="sidebarSearch">
						...
						<div class="BlogSearch"><h5><?php ('Quick search');?></h5>
