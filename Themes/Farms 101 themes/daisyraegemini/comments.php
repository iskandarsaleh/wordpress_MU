...
<?php foreach ($comments as $comment) : ?>
	...
	<div class="commentid">
		...
		<p class="commentby"><?php comment_type(__(''), __(''), __('')); ?> <?php _e(''); ?><?php if (function_exists('avatar_display_comments')){ avatar_display_comments(get_comment_author_email(),'48',''); } ?>&nbsp;&nbsp; <?php comment_author_link() ?></p>
