...
function veryplaintxt_homelink() {
	global $wp_db_version;
	$veryplaintxt_frontpage = get_option('show_on_front');
	$veryplaintxt_is_front = get_option('page_on_front');

	if ( $veryplaintxt_frontpage == 'page' ) {
		if ( !is_page($veryplaintxt_is_front) || is_paged() ) { ?><li class="page_item_home home-link"><a href="<?php bloginfo('home'); ?>/" title="<?php echo wp_specialchars(get_bloginfo('name'), 1) ?>" rel="home"><?php _e('Home', 'sandbox') ?></a></li><?php }
	} else {
...
function widget_veryplaintxt_homelink($args) {
	...
	$veryplaintxt_is_front = get_option('page_on_front');
?>
<?php if ( $veryplaintxt_frontpage == 'page' ) {
		if ( !is_page($veryplaintxt_is_front) || is_paged() ) { ?><?php echo $before_widget; ?><a href="<?php bloginfo('home'); ?>/" title="<?php echo wp_specialchars(get_bloginfo('name'), 1) ?>" rel="home"><?php echo $title ?></a><?php echo $after_widget; ?><?php }
	} else {
...
// Loads the the Home Link widget options
...
// Loads Simplr-style RSS Links (separate from Meta) widget options
		...
		<table class="editform" cellspacing="2" cellpadding="5" width="100%" border="0" summary="veryplaintxt theme options">
			...
			<tr valign="top">
				...
				<td>
					...
					<span class="info"><?php _e('The layout width determines the normal width of the entire layout. This can be in any unit (e.g., px, pt, em), but I suggest using a percentage (%). Default is <span>80%</span>.', 'veryplaintxt'); ?></span>
				</td>
			</tr>
			...
			<tr valign="top">
				...
				<td>
					...
					<span class="info"><?php _e('The maximum width determines how wide the layout can be. When viewed in a large screen, this keeps text lines from running long (i.e., difficult hard to read). Note that this has no effect in Internet Explorer 6 and below. You may leave this blank. Default is <span>55em</span>.', 'veryplaintxt'); ?></span>
				</td>
			</tr>
			...
			<tr valign="top">
				...
				<td>
					...
					<span class="info"><?php _e('The minimum width determines how narrow the layout can be. When viewed in a small area, this keeps the layout from becoming too narrow. Note that this has no effect in Internet Explorer 6 and below. You may leave this blank. Default is <span>35em</span>.', 'veryplaintxt'); ?></span>
				</td>
			</tr>
			...
			<tr valign="top">
				...
				<td>
					...
					<br/>
					<span class="info"><?php _e('Choose one of the options for the alignment of the post entry text. Default is <span>left</span>.', 'veryplaintxt'); ?></span>
				</td>
			</tr>
			...
			<tr valign="top">
				...
				<td>
					...
					<br/>
					<span class="info"><?php _e('The sidebar can be positioned to the left or the right of the main content column. Default is <span>right of content</span>.', 'veryplaintxt'); ?></span>
				</td>
			</tr>
			...
			<tr valign="top">
				...
				<td>
					...
					<br/>
					<span class="info"><?php _e('Choose one of the options for the alignment of the sidebar text. Default is <span>centered</span>.', 'veryplaintxt'); ?></span>
				</td>
			</tr>
