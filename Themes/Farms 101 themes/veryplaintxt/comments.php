...
<?php if ( get_comment_type() == "comment" ) : ?>
		<li id="comment-<?php comment_ID() ?>" class="<?php veryplaintxt_comment_class() ?>">
			<div class="comment-author vcard"><?php if (function_exists('avatar_display_comments')){ avatar_display_comments(get_comment_author_email(),'48',''); } ?>&nbsp;&nbsp;<span class="fn n"><?php comment_author_link() ?></span> wrote:</div>
