...
<div id="content" class="widecolumn">
  ...
  <div class="post" id="post-<?php the_ID(); ?>">
    <h2><a href="<?php echo get_permalink($post->post_parent); ?>" rev="attachment"><?php echo get_the_title($post->post_parent); ?></a> &raquo; <a href="<?php echo get_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link:');?> <?php the_title(); ?>">
      <?php the_title(); ?>
      </a></h2>
    <div class="entry">
      <p class="<?php echo $classname; ?>"><?php echo $attachment_link; ?><br />
        <?php echo basename($post->guid); ?></p><?php if (function_exists('wp_ozh_wsa')) { wp_ozh_wsa("336280nocolor"); } ?>
      ...
      <p class="postmetadata alt"> <small> This entry was posted
        ...
        <?php comments_rss_link('RSS 2.0'); ?> <?php _e('feed');?>.
