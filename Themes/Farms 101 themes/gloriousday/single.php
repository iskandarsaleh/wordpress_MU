...
<div id="main">
	<div id="content">
	    ...
	    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
            ...
            <p class="box left"><?php the_author_posts_link(); ?></p>
            <h2 class="title"><a href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a></h2>
            <div class="meta">
				      <p>Posted at <?php the_time();?> under <?php the_category(',') ?> <?php edit_post_link(); ?></p>
			      </div>
			      <div class="entry">
            ...
            <p class="comments">
              <?php comments_number(__('No responses yet'), __('One response so far'), __('% responses so far')); ?>
            </p>
