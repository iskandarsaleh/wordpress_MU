...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li id="comment-<?php comment_ID() ?>" class="<?php echo $oddcomment; /* Style differently if comment author is blog author */ if ($comment->comment_author_email == get_the_author_email()) { echo ' authorcomment'; } ?>">
			<div class="cmtinfo"><small class="commentmetadata"></small><cite><?php if (function_exists('avatar_display_comments')){ avatar_display_comments(get_comment_author_email(),'48',''); } ?>&nbsp;&nbsp;<?php comment_author_link() ?></cite><em><?php _e('on');?> <?php comment_date('d M Y') ?> <?php _e('at');?> <?php comment_time() ?> <?php edit_comment_link('edit this','',''); ?></em><a href="#comment-<?php comment_ID() ?>" title=""><span class="number"><?php echo $commentnumber; $commentnumber++;?></span></a></div>			
