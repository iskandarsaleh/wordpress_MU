...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>"><?php if(function_exists('cmd_show_avatar')) cmd_show_avatar(); ?>
			<?php if (function_exists('avatar_display_comments')){ avatar_display_comments(get_comment_author_email(),'48',''); } ?>&nbsp;&nbsp;<?php comment_author_link() ?> <?php _e('says');?>: <?php if ($comment->comment_approved == '0') : ?>
