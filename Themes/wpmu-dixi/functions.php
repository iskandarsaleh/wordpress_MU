	...
	if ($blogs) {
		...
		foreach ($blogs as $blog) {
            ...
            $custom_this_date = substr($thispost[0]->post_date_gmt,0,11);
						...
						echo $begin_wrap.'<strong class="feat-title"><a href="'.$thispermalink
...
function the_excerpt_feature($excerpt_length=40, $allowedtags='', $filter_type='', $use_more_link=true, $more_link_text="...read full article&raquo;", $force_more_link=true, $fakeit=1, $fix_tags=true) {
...
if ( function_exists('register_sidebar') )
register_sidebar(array('name'=>'Frontpage',
'before_widget' => '<li id="%1$s" class="widget %2$s">',
'after_widget' => '</li>',
'before_title' => '<h3>',
'after_title' => '</h3>',
...
$options = array (
    ...
    array (	"name" => __("Used rss network in blog?:"),
    ...
    array (	"name" => __("Show login panel and profiles?:"),
...
"options" => array("top", "center", "bottom")),
   ...
   array (	"name" => __("Change your global body font colour?"),
    ...
    array(	"name" => __("Featured Video Embed Code *optional"),
   ...
   ////feed one//////
    ...
    array(	"name" => __("<strong>Insert the first rss feed name here</strong>"),
...
////feed third//////
    ...
    array(	"name" => __("<br /><strong>Insert the third feed name here</strong>"),
...
////feed fourth//////
    ...
    array(	"name" => __("<br /><strong>Insert the fourth feed name here</strong>"),
...
////feed fifth//////
    ...
    array(	"name" => __("<br /><strong>Insert the fifth feed name here</strong>"),
...
add_theme_page($themename. 'Options', 'Theme Options', 'edit_themes', 'functions.php', 'mytheme_wpmu_dixi_admin');
}
...
<?php if(($_GET["page"] == "functions.php") || ($_GET["page"] == "site-intro.php") || ($_GET["page"] == "gallery.php")) { ?>
...
add_custom_image_header('', 'wpmu_dixi_admin_header_style');
}
} else { }
...
add_theme_page(_g ('Site Intro'),  _g ('Site Intro'),  'edit_themes', 'site-intro.php', 'wpmu_dixi_intro');
}
...
<p><input type="submit" class="submit-button" name="delete_<? echo "$i"; ?>" value="delete" /></p>
</div>
<?php }
}
closedir($handle);
...
function wpmu_dixi_add_gallery() {
add_theme_page(_g ('Gallery'),  _g ('Gallery'),  'edit_themes', 'gallery.php', 'wpmu_dixi_gallery');
}

add_action('admin_menu', 'wpmu_dixi_add_intro');
add_action('admin_menu', 'wpmu_dixi_add_gallery');
