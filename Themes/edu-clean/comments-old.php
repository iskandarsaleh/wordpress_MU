...
<h4 id="comments"><?php comments_number(__('No Comments Yet'), __('1 Comment Already'), __('% Comments Already')); ?></h4>
<?php } else { ?>
<h4 id="comments"><?php _e('Sorry, the comment form is closed at this time.'); ?></h4>
<?php } ?>
...
<strong><?php _e('Your Comment Is Under Moderation'); ?></strong>
<?php else: ?>
<?php comment_text(); ?>
<?php endif; ?>
...
<h4><?php echo $trackbackcounter; ?><?php _e('Pingback &amp; Trackback'); ?></h4>
...
<input name="submit" type="submit" value="<?php echo attribute_escape(__('Submit Comment')); ?>" class="st" id="submit" alt="submit" />
