...
<?php if($tn_wpmu_tri_rss_one_url == ''){ ?>
<?php } else { ?>
<div class="tabbertab">
<h3><?php echo "$tn_wpmu_tri_rss_one"; ?></h3>
<?php
$get_net_gfeed_url = $tn_wpmu_tri_rss_one_url;
$rss = @fetch_rss("$get_net_gfeed_url");
if ((isset($rss->items)) && (count($rss->items)>=1)) {
foreach(array_slice($rss->items,0,$tn_wpmu_tri_rss_one_sum) as $item){
...
$feed_descriptions = substr_replace($feed_descriptions,"...","$tn_wpmu_tri_rss_one_wordcount");
} else {
$feed_descriptions = '';
}
$msg .= "
...
<?php if($tn_wpmu_tri_rss_two_url == ''){ ?>
<?php } else { ?>
<div class="tabbertab">
<h3><?php echo "$tn_wpmu_tri_rss_two"; ?></h3>
<?php
$get_net_gfeed_url2 = $tn_wpmu_tri_rss_two_url;
$rss2 = @fetch_rss("$get_net_gfeed_url2");
if ((isset($rss2->items)) && (count($rss2->items)>=1)) {
foreach(array_slice($rss2->items,0,$tn_wpmu_tri_rss_two_sum) as $item2){
...
$feed_descriptions2 = substr_replace($feed_descriptions2,"...","$tn_wpmu_tri_rss_two_wordcount");
} else {
$feed_descriptions2 = '';
}
$msg2 .= "
...
<?php if($tn_wpmu_tri_rss_three_url == ''){ ?>
<?php } else { ?>
<div class="tabbertab">
<h3><?php echo "$tn_wpmu_tri_rss_three"; ?></h3>
<?php
$get_net_gfeed_url3 = $tn_wpmu_tri_rss_three_url;
$rss3 = @fetch_rss("$get_net_gfeed_url3");
if ((isset($rss3->items)) && (count($rss3->items)>=1)) {
foreach(array_slice($rss3->items,0,$tn_wpmu_tri_rss_three_sum) as $item3){
...
$feed_descriptions3 = substr_replace($feed_descriptions3,"...","$tn_wpmu_tri_rss_three_wordcount");
} else {
$feed_descriptions3 = '';
}
$msg3 .= "
...
<?php if($tn_wpmu_tri_rss_four_url == ''){ ?>
<?php } else { ?>
<div class="tabbertab">
<h3><?php echo "$tn_wpmu_tri_rss_four"; ?></h3>
<?php
$get_net_gfeed_url4 = $tn_wpmu_tri_rss_four_url;
$rss4 = @fetch_rss("$get_net_gfeed_url4");
if ((isset($rss4->items)) && (count($rss4->items)>=1)) {
foreach(array_slice($rss4->items,0,$tn_wpmu_tri_rss_four_sum) as $item4){
...
$feed_descriptions4 = substr_replace($feed_descriptions4,"...","$tn_wpmu_tri_rss_four_wordcount");
} else {
$feed_descriptions4 = '';
}
$msg4 .= "
...
<?php if($tn_wpmu_tri_rss_five_url == ''){ ?>
<?php } else { ?>
<div class="tabbertab">
<h3><?php echo "$tn_wpmu_tri_rss_five"; ?></h3>
<?php
$get_net_gfeed_url5 = $tn_wpmu_tri_rss_five_url;
$rss5 = @fetch_rss("$get_net_gfeed_url5");
if ((isset($rss5->items)) && (count($rss5->items)>=1)) {
foreach(array_slice($rss5->items,0,$tn_wpmu_tri_rss_five_sum) as $item5){
...
$feed_descriptions5 = substr_replace($feed_descriptions5,"...","$tn_wpmu_tri_rss_five_wordcount");
} else {
$feed_descriptions5 = '';
}
$msg5 .= "
